...
struct MomentEntryView: View {
    ...
    @State private var isShowingConcelConfirmation = false
                ...
                ToolbarItem(placement: .cancellationAction) {
                    Button("Cancel", systemImage: "xmark") {
                        if title.isEmpty, note.isEmpty, imageData == nil {
                            ...
                            isShowingConcelConfirmation = true
                        }
                    }
                    .confirmationDialog("Discard Moment", isPresented: $isShowingConcelConfirmation) {
